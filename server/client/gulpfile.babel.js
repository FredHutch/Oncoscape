// generated on 2016-01-21 using generator-gulp-webapp 1.0.4
...
gulp.task('vendor-images', () => {
  return gulp.src('app/vendor/images/**/*')
    .pipe($.if($.if.isFile, $.cache($.imagemin({
      progressive: true,
      interlaced: true,
      // don't remove IDs from SVGs, they are often used
    ...
    .pipe(gulp.dest('../server/public/styles/images'));
});
...
gulp.task('serve', ['files', 'styles', 'fonts'], () => {
  ...
  gulp.watch(['app/components/*.scss','app/styles/**/*.scss'], ['styles']);
...
gulp.task('build', ['lint', 'html', 'images', 'vendor-images', 'fonts', 'extras'], () => {
