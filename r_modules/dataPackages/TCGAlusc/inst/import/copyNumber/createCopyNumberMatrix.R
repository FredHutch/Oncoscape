...
table.cn <- read.table(file="../../../../RawData/TCGAlusc/mysql_cbio_cna.csv", header=F, skip=3, as.is=T)
## 501 samples(patients) x 22184 genes

sampleString <- readLines(con="../../../../RawData/TCGAlusc/mysql_cbio_cna.csv", n=2)[[2]]
...
checkEquals(as.list(table(mtx.cn)), list(`-2`=62209,`-1`=3394593,  `0`=4482263, `1`=2929066, `2`=246053))
