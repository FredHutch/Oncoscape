...
$templateCache.put("app/components/pca/pca.html","<os-tray content=\"tray-content-block\"><section class=\"tray-content\"><div class=\"row\"><div class=\"col-xs-12 form-item\"><label>Data Type</label><div class=\"input-group\"><div class=\"dropdown bs-dropdown\"><button style=\"width:260px;\" class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"dropdownMenu1\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">{{vm.pcaType}}<span class=\"caret\"></span></button><ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\" style=\"width:260px;\"><li class=\"markers-command hvr-sweep-to-right\" ng-repeat=\"item in vm.pcaTypes\" ng-click=\"vm.pcaType=item\">{{item}}</li></ul></div></div></div><div class=\"col-xs-12 form-item\"><label>Run Parameters</label><div class=\"legend-bar-container\"><div ng-repeat=\"item in vm.optRunParams\" style=\"position:relative;background-color:#FFF;padding:2px 10px;line-height:25px;\">{{item.name}} {{item.count}} <label class=\"switch\" style=\"float:right\" tooltip=\"Toggle Visibility\" tooltip-placement=\"left\"><input type=\"checkbox\" class=\"switch-input\" ng-model=\"item.show\" ng-change=\"vm.runParamsToggle(item)\"> <span class=\"switch-label\" data-on=\"On\" data-off=\"Off\"></span> <span class=\"switch-handle\"></span></label></div></div></div><div class=\"col-xs-12 form-item\"><label>Overlay</label><div ng-if=\"vm.showOverlayForm\" class=\"kanban-column\"><div class=\"portlet legend-bar-container\"><div class=\"portlet-content\"><div>Dataset<div class=\"input-group\" style=\"width:100%\"><div class=\"dropdown bs-dropdown\"><button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"dropdownMenu1\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">{{vm.overlaySource}}<span class=\"caret\"></span></button><ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\" style=\"width:260px;max-height:250px;overflow-y:scroll\"><li class=\"markers-command hvr-sweep-to-right\" ng-repeat=\"item in vm.datasources\" ng-click=\"vm.overlaySource=item.name\">{{item.name}}</li></ul></div></div></div><div>Type<div class=\"input-group\" style=\"width:100%\"><div class=\"dropdown bs-dropdown\"><button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"dropdownMenu1\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\" style=\"max-width: 212px;\">{{vm.overlayType}}<span class=\"caret\"></span></button><ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\" style=\"width:260px;max-height:250px;overflow-y:scroll\"><li class=\"markers-command hvr-sweep-to-right\" ng-repeat=\"item in vm.overlayTypes\" ng-click=\"vm.overlayType=item\">{{item}}</li></ul></div></div></div><div style=\"width:100%; display:inline-block\"><button ng-click=\"vm.callOverlay()\" class=\"btn btn-default\" type=\"button\" id=\"\" aria-haspopup=\"true\" aria-expanded=\"true\" style=\"float:right;margin-top:10px;background-color:#039BE5\"><span class=\"glyphicon glyphicon-chevron-right\" style=\"color:#FFF\"></span></button></div></div></div></div><button class=\"btn btn-default btn-no-focus\" type=\"button\" style=\"width:100%;font-weight: 300;\" ng-click=\"vm.showOverlayForm = true\">Add</button></div><div ng-if=\"vm.legendCaption.length>0\" class=\"col-xs-12 form-item\"><label>Patient {{vm.legendCaption}}</label><div ng-repeat=\"item in vm.legendNodes\" class=\"legend-bar legend-bar-button\" style=\"border-color:{{item.color}};\">{{item.name}}<span id=\"{{item.id}}\" class=\"legend-count\"></span> <label style=\"float:right;padding-top:5px;\" class=\"btn-group\"><button tooltip=\"Deselect\" tooltip-placement=\"left\" ng-click=\"vm.deselectColor(item)\" class=\"btn btn-xs btn-default\" style=\"background-color:#47a8d8;color:#FFF;text-shadow: 0 1px rgba(0, 0, 0, 0.2);width:24px;margin-right:1px;\"><i class=\"fa fa-circle-o\"></i></button> <button tooltip=\"Select\" tooltip-placement=\"left\" ng-click=\"vm.selectColor(item)\" class=\"btn btn-xs btn-default\" style=\"background-color:#47a8d8;color:#FFF;text-shadow: 0 1px rgba(0, 0, 0, 0.2);width:24px;margin-left:1px;\"><i class=\"fa fa-dot-circle-o\"></i></button></label></div></div><div class=\"col-xs-12 form-item\"><label>Color Feature</label> <button class=\"btn btn-default btn-no-focus\" type=\"button\" style=\"width:100%;font-weight: 300;\" ng-click=\"vm.showPanelColor = true\">Add</button></div><div class=\"col-xs-12 form-item\"><label>Variance Explained</label><div><os-tray-piechart chart-data1=\"vm.pc1\" chart-data2=\"vm.pc2\" chart-height=\"130\"></os-tray-piechart><div class=\"pca-pc1-label\"><span>PC1</span><br>{{vm.pc1[0].value}}%</div><div class=\"pca-pc2-label\"><span>PC2</span><br>{{vm.pc2[0].value}}%</div></div></div><div class=\"col-xs-12 form-item\"><label>Loadings</label><os-tray-barchart chart-data=\"vm.loadings\" chart-height=\"100\"></os-tray-barchart></div></div></section></os-tray><div id=\"modalRun\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\"><div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-body\"><h2 style=\"margin-top:0px;\">Estimated runtime is approximately {{vm.runTime}}.</h2><p>Would you like to update the run parameters?</p><div class=\"legend\" ng-repeat=\"item in vm.optRunParams\"><label class=\"switch\"><input type=\"checkbox\" class=\"switch-input\" ng-model=\"item.show\"> <span class=\"switch-label\" data-on=\"On\" data-off=\"Off\"></span> <span class=\"switch-handle\"></span></label> <span style=\"padding-left:20px;\">{{item.name}}</span></div></div><div style=\"position:absolute;right:10px;bottom:10px;\"><button class=\"btn btn-default\" ng-click=\"vm.hideModal()\">Cancel</button> <button class=\"btn btn-primary\" ng-click=\"vm.runParamsToggle()\">Continue</button></div></div></div></div><div id=\"modal_intersection\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\"><div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-body\"><div style=\"margin-top:0px;margin-bottom:20px\">Sorry, the datasets chosen have no intersecting markers. Correlation calculation is impossible using {{vm.geneSet.name}}.</div><div style=\"position:absolute;right:10px;bottom:10px;\"><button class=\"btn btn-default\" ng-click=\"vm.hideModal()\">Return</button></div></div></div></div></div><div id=\"modal_NArun\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\"><div class=\"modal-dialog\" role=\"document\"><div class=\"modal-content\"><div class=\"modal-body\"><span style=\"margin-top:0px;\"><h3>Sorry, PCA could not be calculated.</h3><br>Geneset: {{vm.geneSet.name}}<br>Reason: {{vm.error}}</span></div><div style=\"position:absolute;right:10px;bottom:10px;\"><button class=\"btn btn-default\" ng-click=\"vm.hideModal()\">Return</button></div></div></div></div><section class=\"tray-content-block\"><div class=\"tool-container\"><h2 class=\"h2-tool\">Principal Component Analysis</h2><span class=\"h3-tool\">{{vm.datasource.source}} {{vm.datasource.name}}</span><div id=\"pca-chart\" class=\"pca\"></div></div></section><os-color-panel ng-if=\"vm.showPanelColor\" close=\"vm.showPanelColor=false\"></os-color-panel>");
...
//# sourceMappingURL=../maps/scripts/app-f34b7f2d5b.js.map
