...
runTimedTests <- function()
{
   ...
   write(system.time(library(RUnit)), file=fileName, append=TRUE)
   write(system.time(library(OncoDev14)), file=fileName, append=TRUE)
   write(system.time(library(TCGAgbm)), file=fileName, append=TRUE)
