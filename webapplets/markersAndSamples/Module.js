...
function displayMarkersNetwork(msg)
{
   ...
   if(msg.status == "success"){
         graphAsString = msg.payload["g.markers.json"];
...
function datasetSpecified (msg)
{
   ...
   payload = {datasetName: datasetName, items: ["g.markers.json"]}
   var newMsg = {cmd: "getDatasetItemsByName",  callback: "displayMarkersNetwork",
