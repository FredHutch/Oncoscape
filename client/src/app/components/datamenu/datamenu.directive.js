(function() {
    ...
    function dataMenu() {
        ...
        var directive = {
            restrict: 'E',
            templateUrl: 'app/components/datamenu/datamenu.html',
        ...
        /** @ngInject */
        function DataMenuController(osApi, $state, $scope, $sce, $timeout, $rootScope, $filter) {
