(function() {
    ...
    function heatmap() {
        ...
        function HeatmapController(d3, osApi, $state, $timeout, $scope, $stateParams, $window, _, $http) {
            ...
            vm.orderTypes = [
                {"value":"hclust", name:"by cluster"},
                {"value":"probecontrast",name:"by probe name and contrast name"},
                {"value":"probe",name:"by probe name"},
                {"value":"contrast",name:"by contrast name"},
                {"value":"custom",name:"by log2 ratio"}]
          ...
          //  var colmap = elChart.append("svg").classed("colormap", true);
            ...
            function heatmap() {
                ...
                //svg.select("g").remove();
                //svg.attr("width", width).attr("height", height).style("left", x+100).style("top", y+150).style("position", "absolute");
