(function() {
    ...
    function geneset() {
        ...
        var directive = {
            restrict: 'E',
            templateUrl: 'app/components/geneset/geneset.html',
            controller: GenesetController,
            controllerAs: 'vm',
        ...
        /** @ngInject */
        function GenesetController(osApi, $state, $timeout, $scope, $stateParams) {
