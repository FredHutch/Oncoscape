(function() {
    ...
    angular
        .module('oncoscape')
        .directive('osImportGeneset', importgeneset);

    /** @ngInject */
    function importgeneset() {

        var directive = {
            restrict: 'E',
            templateUrl: 'app/components/importgeneset/importgeneset.html',
            controller: ImportgenesetController,
            controllerAs: 'vm',
        ...
        /** @ngInject */
        function ImportgenesetController(osApi, d3, _) {
