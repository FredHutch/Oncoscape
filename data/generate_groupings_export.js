...
exports.secondarySort = function(docs,secondarySortDocs,category){
	...
	for(var i=0; i<docsLength; i++){
		...
		for(var j=0; j<secondarySortDocsLength; j++){
...
exports.clusterGroupByValue = function(docsSorted,category){
...
exports.formatDocsForInsertion = function(docs,annotationData,datasetLabel,category){
