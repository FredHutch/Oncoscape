...
#----------------------------------------------------------------------------------------------------
initUserDataStore <- function(ws, msg)
{
...
#----------------------------------------------------------------------------------------------------
getUserDataStoreSummary <- function(ws, msg)
{
   uds <- payloadToUserDataStoreInstance(msg$payload)
   tbl <- getSummary(uds)
   mtx <- as.matrix(tbl)
...
#----------------------------------------------------------------------------------------------------
userDataStoreAddData <- function(ws, msg)
{
...
#----------------------------------------------------------------------------------------------------
userDataStoreGetDataItem <- function(ws, msg)
{
  payload <- msg$payload
...
#----------------------------------------------------------------------------------------------------
userDataStoreDeleteDataItem <- function(ws, msg)
{
  payload <- msg$payload
