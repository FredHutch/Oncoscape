 ...
 */
function getValuePreview(object: Object, value: string): string {
 ...
 */
function getPreview(object: string): string {
  let value = '';
  if (isObject(object)) {
...
export class JSONFormatter {
  ...
  removeChildren(animated: boolean = false) {
    const childrenElement = this.element
      .querySelector(`div.${cssClass('children')}`) as HTMLDivElement;
