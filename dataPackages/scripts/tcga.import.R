...
os.table.mappings <- list(
        "pt" = list(
                ...
                #lung only 
                'fev1_fvc_ratio_prebroncholiator' = list(name = "prefev1.ratio", data = "os.class.tcgaNumeric"),
                'fev1_percent_ref_prebroncholiator' = list(name = "prefev1.percent", data = "os.class.tcgaNumeric"),
                'fev1_fvc_ratio_postbroncholiator' = list(name = "postfev1.ratio", data = "os.class.tcgaNumeric"),
                'fev1_percent_ref_postbroncholiator' = list(name = "postfev1.percent", data = "os.class.tcgaNumeric"),
                'carbon_monoxide_diffusion_dlco' = list(name = "carbon.monoxide.diffusion", data = "os.class.tcgaNumeric"),
                # Procedure Table 
        ...
        "omf"= list('bcr_patient_barcode' = list(name = "PatientID", data = "os.class.tcgaId"), 
                    ...
                    # Procedure Table 
                    'days_to_surgical_resection' = list(name = "date", data = "os.class.tcgaNumeric"),
                    ...
                    'days_to_other_malignancy_dx' = list(name = "date_other_malignancy", data = "os.class.tcgaNumeric"),
                    ...
                    #Absent Table 
                    'days_to_other_malignancy_dx' = list(name = "omfdx", data = "os.class.tcgaNumeric"),
        ...
        "nte"= list('bcr_patient_barcode' = list(name = "PatientID", data = "os.class.tcgaId"),
                    'days_to_new_tumor_event_after_initial_treatment' = list(name = "omfdx", data = "os.class.tcgaNumeric"),
                    'new_tumor_event_dx_days_to' = list(name = "omfdx", data = "os.class.tcgaNumeric"),
                    ...
                    'new_tumor_event_type' = list(name = "newTumor", data = "os.class.newTumor"),
                    # Procedure Table 
                    'new_tumor_event_surgery_days_to_loco' = list(name = "date_locoregional", data = "os.class.tcgaNumeric"),
                    'new_tumor_event_surgery_days_to_met' = list(name = "date_metastatic", data = "os.class.tcgaNumeric"),
                    'new_tumor_event_surgery' = list(name = "new_tumor_event_surgery", data = "os.class.tcgaCharacter"),
                    'days_to_new_tumor_event_additional_surgery_procedure' = list(name = "date", data = "os.class.tcgaNumeric"),
