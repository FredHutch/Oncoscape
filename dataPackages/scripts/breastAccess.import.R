...
os.enum.na <- c("", "NA", "[NOTAVAILABLE]","[UNKNOWN]","[NOT AVAILABLE]","[NOT EVALUATED]","UKNOWN","[DISCREPANCY]","NOT LISTED IN MEDICAL RECORD","[NOT APPLICABLE]","[PENDING]","PENDING", "[NOT AVAILABLE]","[PENDING]","[NOTAVAILABLE]","NOT SPECIFIED","[NOT AVAILABLE]|[NOT AVAILABLE]","[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]","[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]","[NOT AVAILABLE]|[NOT AVAILABLE]|[NOT AVAILABLE]", "UNK", "NOT PERFORMED", "NOT TESTED")
#os.enum.other <- c( "OTHER","OTHER: SPECIFY IN NOTES","OTHER (SPECIFY BELOW)","SPECIFY")
os.enum.logical.true  <- c("TRUE","YES","1","Y", "POSITIVE")
os.enum.logical.false <- c("FALSE","NO","0","N", "NEGATIVE")
os.ignore.columns <- c("Institution", "CancerType", "TissueConsentDate", "BloodConsentDate", "DataConsentDate", "FutureConsentDate", "GeneticDataConsentDate", "riskFactorQuestionaireCompletedDate",
						"PrimaryPathDiagnosis2", "MRN", "DateOfStatus", "DiedOfDisease", "BRCA_testing_note", "Her2_CEP17", "CollectionIRBNum")
...
### TCGA Date
setClass("os.class.Date");
setAs("character","os.class.Date", function(from){
        ...
        if (grep("\\d\\d/\\d\\d/\\d\\d", from ) ){
                return(format(as.Date(from, "%m/%d/%y"), "%m/%d/%Y"))
        }
...
### TCGA Character
setClass("os.class.Character");
setAs("character","os.class.Character", function(from){
...
### TCGA Numeric
setClass("os.class.Numeric");
setAs("character","os.class.Numeric", function(from){
        ...
        # Kill If Not In Enum or Na
        stop(paste("os.class.Numeric not properly set: ", from[!is.numeric(from)], collapse=";"))
        
})

### TCGA Boolean
setClass("os.class.Boolean");
setAs("character","os.class.Boolean", function(from){
...
os.data.batch(
        ...
        checkClassType = "os.class.Character")