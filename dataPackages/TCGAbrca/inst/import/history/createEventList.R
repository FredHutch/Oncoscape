...
test_create.Radiation.record <- function()
{
    ...
    checkTrue(is.list(x))
    checkEquals(x[[1]], list(PatientID="TCGA.HN.A2OB", PtNum=1010, study=study, Name="Radiation", Fields=list(date=c(NA,NA), therapyType="external", intent=NA, target="Primary Tumor Field", totalDose=5000, totalDoseUnits="cGy", numFractions=25)))
   
   x <- create.Radiation.record("TCGA-D8-A1JG")  # total dose is "42.5+10"
   checkEquals(x[[1]], list(PatientID="TCGA.D8.A1JG", PtNum=730, study=study, Name="Radiation", Fields=list(date=c( "05/12/2010", "06/06/2010"), therapyType="external beam", intent="adjuvant", target="Primary Tumor Field", totalDose="42.5+10", totalDoseUnits="cGy", numFractions=21)))
} # test_create.Radiation.record
#------------------------------------------------------------------------------------------------------------------------
