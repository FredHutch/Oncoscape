...
table.mut <- read.table(file="../../../../RawData/TCGAhnsc/mysql_cbio_mut.txt", header=T, as.is=T)
...
checkEquals(mtx.mut["TCGA.CQ.6219.01", "CDT1"], "S125L")
checkEquals(mtx.mut["TCGA.BB.7861.01", "MEIS3P1"], "Y188*")
checkEquals(mtx.mut["TCGA.CQ.6220.01", "ARV1"], "168_169MT>IP")
