...
load(file="../../../../TCGAluad/inst/extdata/events.RData")
load(file="../../../../TCGAluad/inst/extdata/ptHistory.RData")
load(file="../../../../TCGAluad/inst/extdata/historyTypes.RData")
load(file="../../../../TCGAluad/inst/extdata/tbl.ptHistory.RData")
list.TCGAluad <- history
ptList.TCGAluad <- ptList
catList.TCGAluad <- catList
ptTable.TCGAluad <- tbl.ptHistory
checkEquals(length(list.TCGAluad), 5502)

load(file="../../../../TCGAlusc/inst/extdata/events.RData")
load(file="../../../../TCGAlusc/inst/extdata/ptHistory.RData")
load(file="../../../../TCGAlusc/inst/extdata/historyTypes.RData")
load(file="../../../../TCGAlusc/inst/extdata/tbl.ptHistory.RData")
list.TCGAlusc <- history
ptList.TCGAlusc <- ptList
catList.TCGAlusc <- catList
ptTable.TCGAlusc <- tbl.ptHistory
...
run <- function()
{
    ...
    checkEquals(as.list(table(unlist(lapply(history, function(e) e["Name"])))), list(`Absent`=85,`Background` = 996,
      `Birth`=1015, `Diagnosis`=1015,`Drug`=675,`Encounter`=2863,`Pathology`=1195, `Procedure`=166, `Progression`=55,  
      `Radiation`=181, `Status`=1015,`Tests`=1476))
