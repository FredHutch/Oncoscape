...
table.cn <- read.table(file="../../../../RawData/TCGAcoadread/mysql_cbio_cna.csv", header=F, skip=3, as.is=T)
## 563 samples(patients) x 23575 genes

sampleString <- readLines(con="../../../../RawData/TCGAcoadread/mysql_cbio_cna.csv", n=2)[[2]]
