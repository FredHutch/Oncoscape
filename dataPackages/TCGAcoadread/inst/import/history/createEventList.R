...
load(file="../../../../TCGAcoad/inst/extdata/events.RData")
load(file="../../../../TCGAcoad/inst/extdata/ptHistory.RData")
load(file="../../../../TCGAcoad/inst/extdata/historyTypes.RData")
load(file="../../../../TCGAcoad/inst/extdata/tbl.ptHistory.RData")
list.TCGAcoad <- history
ptList.TCGAcoad <- ptList
catList.TCGAcoad <- catList
ptTable.TCGAcoad <- tbl.ptHistory
checkEquals(length(list.TCGAcoad), 4467)

load(file="../../../../TCGAread/inst/extdata/events.RData")
load(file="../../../../TCGAread/inst/extdata/ptHistory.RData")
load(file="../../../../TCGAread/inst/extdata/historyTypes.RData")
load(file="../../../../TCGAread/inst/extdata/tbl.ptHistory.RData")
list.TCGAread <- history
ptList.TCGAread <- ptList
catList.TCGAread <- catList
ptTable.TCGAread <- tbl.ptHistory
