library(RUnit)
## Create HM450 R data
table.meth <- read.table(file="../../../../RawData/TCGAprad/mysql_cbio_methHM450.csv", header=F, skip=3, as.is=T)
## 451 samples(patients) x 16183 genes

sampleString <- readLines(con="../../../../RawData/TCGAprad/mysql_cbio_methHM450.csv", n=2)[[2]]
...
checkEquals(length(which(is.na(mtx.meth))), 3218)   #
checkEquals(mtx.meth["TCGA.EJ.7794.01", "CD52"], 0.8055884, tolerance=5)
